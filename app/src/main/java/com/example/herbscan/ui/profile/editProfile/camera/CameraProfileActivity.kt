package com.example.herbscan.ui.profile.editProfile.camera
...
import com.example.herbscan.databinding.ActivityCameraProfileBinding
...
class CameraProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            tvCancelCamera.setOnClickListener { finish() }
    ...
    companion object {
        private const val TAG = "CameraProfileActivity"
